...
# tflite_stratsplit_classifspeed_filepath = 'tflite_finetunedstratifiedsplit_extradata_mobnetv3small_speedclassif.tflite'
# tflite_NONstratsplit_classifspeed_filepath = 'tflite_nonstratsplit_finetuned_extradata_mobnetv3small_speedclassif.tflite'

# tflite_regression_filepath = 'tflite_extradata_angleregression_finetuned_mobnetv3small.tflite'

# class Model:
#     os.environ['TF_XLA_FLAGS'] = '--tf_xla_enable_xla_devices' #enable gpu
#     # shit ones that didnt work that well
#     # speed_model = 'tflite_finetuned_mbnetv3small_classification.tflite'
#     # angle_model = 'tflite_finetuned_mobnetv3small_regression.tflite'
...
class Model:
    os.environ['TF_XLA_FLAGS'] = '--tf_xla_enable_xla_devices' #enable gpu
    speed_model = 'tflite_nonstratsplit_finetuned_extradata_mobnetv3small_speedclassif.tflite'
    angle_model = 'tflite_extradata_angleregression_finetuned_mobnetv3small.tflite'
